// /assets/js/app2.js
import "/corvelloni-contabilidade/assets/js/modules/navigation.js";
import "/corvelloni-contabilidade/assets/js/modules/cookie-consent.js";
...
onReady(() => {
  ...
  if (document.querySelector("[data-help-open]")) {
    idle(() =>
      import("/corvelloni-contabilidade/assets/js/modules/help-dialog.js")
  ...
  if (needCLT) {
    idle(() =>
      import("/corvelloni-contabilidade/assets/js/modules/clt-vs-pj.js")
  ...
  if (needCusto) {
    idle(() =>
      import("/corvelloni-contabilidade/assets/js/modules/custos-abertura-pj.js")
